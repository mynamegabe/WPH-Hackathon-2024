      ...
      <div className="flex flex-row gap-4 flex-wrap">
        {responses.map((applicant, index) => {
          return (
            ...
            >
              <CardBody
                className={`flex flex-row gap-4 w-auto px-4 py-8 items-stretch overflow-hidden`}
              >
                <div className="flex flex-col gap-4 items-center w-56">
                  <img
                    src={
                      siteConfig.apiUrl + "/uploads/avatars/" + applicant.image
                    }
                  ...
                  <div className="flex flex-row gap-2 w-full">
                    <Button
                      ...
                      variant="solid"
                      as={Link}
                      href={`/dashboard/forms/${params.formId}/response/${applicant.id}`}
                    >
                      View Response
                    </Button>
                    <Button
                      ...
                      variant="solid"
                      as={Link}
                      href={`/dashboard/user/${applicant.id}`}
                    >
                      View User
                    </Button>
                  </div>
